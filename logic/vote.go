...
func VoteForPost(userID uint64, p *vo.ParamVoteData) error {
	zap.L().Debug("VoteForPost", zap.Uint64("userID", userID), zap.Int64("postID", p.PostID), zap.Int8("direction", p.Direction))
